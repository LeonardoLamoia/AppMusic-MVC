...
class DetailViewControllerScreen: UIView {
    ...
    lazy var scrollView:UIScrollView = {
        ...
        view.autoresizingMask = .flexibleHeight //altura flexível, auto ajustar
        view.bounces = false
    ...
    private func setupConstraints() {
        let window = UIApplication.shared.connectedScenes
            ...
            .compactMap({$0 as? UIWindowScene})                 //saber a distancia entre safeArea e propria View
        ...
        NSLayoutConstraint.activate([
            ...
            self.playerView.trailingAnchor.constraint(equalTo: trailingAnchor),
