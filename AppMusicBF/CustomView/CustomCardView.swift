...
//  AppMusicBF
//
//  Created by Leonardo Lamoia on 09/11/22.
//
...
class CustomCardView: UIView {
    ...
    var containerButtonConstraints:NSLayoutConstraint?
    ...
    lazy var cardContainerView: UIView = {
        ...
        v.layer.cornerRadius = 30 //arredondamento de bordas
        v.clipsToBounds = true //para permitir arredondar as bordas
        v.layer.shadowOpacity = 1 //colocar sombra
    ...
    private func setUpConstraints(){
        ...
        self.containerButtonConstraints = cardContainerView.bottomAnchor.constraint(equalTo: self.bottomAnchor, constant: -15)
        self.containerButtonConstraints?.isActive = true
    ...
    private func updateLayout(for mode: ViewMode){
        if mode == .full{
            ...
            self.containerButtonConstraints?.constant = 0
            ...
            self.containerButtonConstraints?.constant = -15
