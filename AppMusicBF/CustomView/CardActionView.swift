...
//  AppMusicBF
//
//  Created by Leonardo Lamoia on 11/11/22.
//
...
class CardActionView: UIView {
    ...
    lazy var downloadBtn:UIButton = {
        ...
        btn.setBackgroundImage(UIImage(named: "download")?.withRenderingMode(.alwaysTemplate), for: .normal) // para conseguir fazer alterações na imagem (fazer manipulações)
        btn.tintColor = .white
    ...
    lazy var notInterestedBtn:UIButton = {
        ...
        btn.backgroundColor = .white.withAlphaComponent(0.3)
        btn.layer.cornerRadius = 22.5
        btn.setBackgroundImage(UIImage(named: "restrict")?.withRenderingMode(.alwaysTemplate), for: .normal) // para conseguir fazer alterações na imagem (fazer manipulações)
        btn.tintColor = .white
        btn.clipsToBounds = true
        return btn
    }()
    ...
    lazy var playBtn:UIButton = {
        ...
        btn.setBackgroundImage(UIImage(named: "playBtn")?.withRenderingMode(.alwaysTemplate), for: .normal) // para conseguir fazer alterações na imagem (fazer manipulações)
        btn.tintColor = .black
        btn.clipsToBounds = true
        return btn
    }()
    ...
    lazy var likeBtn:UIButton = {
        ...
        btn.backgroundColor = .white.withAlphaComponent(0.3)
        btn.layer.cornerRadius = 22.5
        btn.setBackgroundImage(UIImage(named: "like")?.withRenderingMode(.alwaysTemplate), for: .normal) // para conseguir fazer alterações na imagem (fazer manipulações)
        btn.tintColor = .white
        btn.clipsToBounds = true
        return btn
    }()
    ...
    lazy var moreBtn:UIButton = {
        ...
        btn.backgroundColor = .white.withAlphaComponent(0.3)
        btn.layer.cornerRadius = 22.5
        btn.setBackgroundImage(UIImage(named: "more")?.withRenderingMode(.alwaysTemplate), for: .normal) // para conseguir fazer alterações na imagem (fazer manipulações)
        btn.tintColor = .white
        btn.clipsToBounds = true
        return btn
    }()
    ...
    private func setupViews(){
        self.addSubview(self.stackView) //adicionando a stack na nossa tela
        ...
        self.likeView.addSubview(self.likeBtn) //adicionando cada elemento dentro da sua propria view
